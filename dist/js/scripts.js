...
if (document.querySelector('.block-photo__slider')) {
  const swiperPhoto = new Swiper('.block-photo__slider', {
    observer: true,
    observeParents: true,
    slidesPerView: 1.2,
    spaceBetween: 10,
    speed: 400,
    navigation: {
      prevEl: '.block-photo__arrow-prev',
      nextEl: '.block-photo__arrow-next',
    },
    breakpoints: {
      480: {
        slidesPerView: 1.5,
...
if (document.querySelector('.block-video__slider')) {
  const swiperVideo = new Swiper('.block-video__slider', {
    observer: true,
    observeParents: true,
    slidesPerView: 1.2,
    spaceBetween: 10,
    speed: 400,
    navigation: {
      prevEl: '.block-video__arrow-prev',
      nextEl: '.block-video__arrow-next',
    },
    breakpoints: {
      480: {
        slidesPerView: 1.5,
...
document.querySelectorAll('.form-block-contacts__input .input, .form-block-contacts__input .textarea').forEach(field => {
  if (field.value.trim() !== '') {
...
document.querySelector('.lang-header__title').addEventListener('click', function () {
  const content = this.closest('.lang-header');
  if (content) {
